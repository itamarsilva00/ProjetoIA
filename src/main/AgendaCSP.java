...
public class AgendaCSP extends CSP<Ocupacao, Horario> {
    ...
    private Ocupacao ocupacao1 = new Ocupacao("estudo 0", 0);
    private Ocupacao ocupacao2 = new Ocupacao("estudo 1", 0);
    ...
    public AgendaCSP() {
        ...
        Domain<Horario> domain = new Domain<>(horario1, horario2);
